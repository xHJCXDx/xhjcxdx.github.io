    ...
    return (
        ...
        <div className="max-w-6xl mx-auto">
            ...
            {PROJECTS.map((project, index) => (
                <div key={index} className="border border-purple-500/50 bg-gradient-to-br from-purple-900/20 to-cyan-900/10 p-6 hover:border-cyan-400/70 transition-all duration-300 group">
