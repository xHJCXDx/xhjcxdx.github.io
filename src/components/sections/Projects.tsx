          ...
          {texts.PROJECTS.map((project, index) => (
            <div key={index} className="border border-purple-500/50 bg-gradient-to-br from-purple-900/20 to-cyan-900/10 p-6 hover:border-cyan-400/70 transition-all duration-300 group flex flex-col">
              ...
              <div className="flex space-x-3 mt-auto">
                ...
                {project.liveDemoUrl && (
                  <a href={project.liveDemoUrl} target="_blank" rel="noopener noreferrer" className="p-2 border border-purple-400 text-purple-400 hover:bg-purple-400/10 transition-all">
                    <Globe size={16} />
                  </a>
                )}
                {project.githubUrl && (
